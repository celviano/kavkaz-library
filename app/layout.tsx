...
export const metadata: Metadata = {
  ...
  verification: {
    google: 'PkQu6QlQ6_Q_bKcNjpPaxtEWna1_FsoA5XFLunMwXX4',
    other: {
      ...
      <body className="min-h-screen flex flex-col bg-bg text-text antialiased">
        ...
        <JsonLd
          data={{
            ...
            description:
              'Маркетплейс исторических книг о Кавказе и Закавказье. Редкие книги, атласы, мемуары и этнографические труды.',
            sameAs: [],
          }}
        />
        <NavigationProgress />
