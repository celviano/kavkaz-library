  ...
  return (
    <article
      className={cn(
        ...
        isPast ? 'opacity-60' : 'hover:border-accent/30 hover:shadow-accent hover:-translate-y-1',
        className,
      )}
      ...
      <div className="relative h-44 bg-surface2 overflow-hidden flex items-center justify-center">
        {event.coverUrl ? (
          ...
          <>
            <svg className="absolute inset-0 w-full h-full opacity-[0.04]" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
              <defs>
                <pattern id={`evt-pat-${event.id}`} x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
            ...
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#2a5c45" strokeWidth="1.2" strokeLinecap="round" className="opacity-20">
        ...
        {isPast && (
          <div className="absolute inset-0 bg-bg/50 flex items-center justify-center">
            <span className="text-xs text-ash font-medium tracking-widest uppercase">Завершено</span>
          </div>
        )}
      </div>
      ...
      <div className="flex flex-col gap-3 p-5 flex-1">
        ...
        <div className="pt-3 border-t border-surface2/60 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 text-xs text-dim min-w-0">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" aria-hidden="true" className="flex-shrink-0">
