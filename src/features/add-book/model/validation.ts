...
export const addBookRules = {
  ...
  pages: [rules.number(1, 9999, 'От 1 до 9999 страниц')],
  price: [
    rules.required('Введите цену'),
    rules.number(0, 9999999, 'Цена не может быть отрицательной'),
  ],
  copies: [rules.number(1, 99, 'От 1 до 99 экземпляров')],
  tags: [rules.maxLength(500, 'Слишком длинный список тегов')],
  description: [rules.maxLength(2000, 'Максимум 2000 символов')],
}
