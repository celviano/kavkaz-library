...
import { COPYRIGHT_LABELS } from '@/entities/ebook/model/types'
    ...
    <FormSection title="Авторские права">
      <div className="flex flex-col gap-3">
        <p className="text-xs text-ash leading-relaxed">
          Загружайте только книги, которые вы имеете право распространять.
          Нарушение авторских прав может повлечь удаление материала.
        </p>
        ...
        <label className={cn(
          ...
          <p className="text-sm text-ink leading-snug">
            Я подтверждаю, что имею право распространять данное произведение,
            и несу ответственность за соблюдение авторских прав
          </p>
        </label>
