      ...
      <section className="relative overflow-hidden py-14 md:py-20 border-b border-surface2">
        ...
        <Container className="relative">
          <div className="max-w-2xl">
            <p className="text-[10px] md:text-[11px] font-medium tracking-[2px] uppercase text-accent mb-3 md:mb-4">
              Контакты
            </p>
            <h1
              className="font-normal text-ink leading-tight mb-3 md:mb-4"
              style={{
            ...
            <p className="text-ash text-sm md:text-lg leading-relaxed">
              Есть вопросы о площадке, хотите разместить коллекцию или стать партнёром —
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="flex flex-col gap-5">
              <a
                href="mailto:hello@caucasuslibrary.ru"
              ...
              >
                ...
                <div>
                  <p className="text-[10px] font-medium tracking-[2px] uppercase text-dim mb-1">
                    Email
                  </p>
              ...
              <div className="flex flex-col gap-4 bg-surface border border-surface2 rounded-2xl p-6">
                ...
                <div>
                  <p className="text-[10px] font-medium tracking-[2px] uppercase text-dim mb-2">
                    Режим ответов
                  </p>
            ...
            <div className="lg:col-span-2 flex flex-col gap-5">
                ...
                {SOCIALS.map(({ label, handle, desc, href, Icon, iconBg, branded }) => (
                  ...
                  >
                    ...
                    <svg
                      ...
                      strokeWidth="1.8"
                      strokeLinecap="round"
                      className="flex-shrink-0 group-hover:translate-x-0.5 transition-all"
                      aria-hidden="true"
                    >
              ...
              <div className="relative overflow-hidden rounded-2xl bg-dark px-6 py-6">
                ...
                <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
                  <div>
                    <p className="text-bg/90 font-medium mb-1">
                      Хотите разместить книги?
                    </p>
                    <p className="text-bg/50 text-sm">
                      Напишите нам — поможем с регистрацией и верификацией
                    </p>
                  </div>
                  <a
                    href="mailto:sellers@caucasuslibrary.ru"
