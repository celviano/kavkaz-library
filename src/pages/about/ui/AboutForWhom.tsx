...
const GROUPS = [
  ...
  },
  {
    ...
    title: 'Историкам и исследователям',
    text: 'Первоисточники, которые раньше приходилось искать в архивах по всему миру — теперь в одном месте. С описаниями, датами и издательскими данными.',
  },
  {
    icon: (
      <svg
    ...
    text: 'Выход на аудиторию, которая целенаправленно ищет редкие исторические книги. Не случайные покупатели — а именно ваши покупатели.',
  },
  {
    icon: (
      <svg
    ...
    text: 'Вы просто хотите узнать, что писали о Кавказе 150 лет назад? Как жили горцы, что думал Грибоедов, какими видели эти земли немецкие учёные? Добро пожаловать.',
  },
]
