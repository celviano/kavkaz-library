...
const STEPS = [
  {
    ...
    text: 'Больше не нужно рыскать по десяткам сайтов и аукционов. История, культура, языки, литература, биографии - всё в одном каталоге с описаниями и данными об издании.',
  },
  {
    number: '02',
    title: 'Объединяем продавцов и покупателей',
    text: 'Коллекционеры, книжные магазины, архивы - каждый может выставить свои книги. Покупатель видит полную картину рынка и находит нужное издание.',
  },
  {
    number: '03',
    title: 'Сохраняем знания',
    text: 'Каждая книга попадает в каталог с историей, тегами и метаданными. Даже если книга продана - информация о ней остаётся. Живая база данных редких изданий.',
  },
  {
    number: '04',
    title: 'Создаём сообщество',
    text: 'Лекции, встречи, выставки - мы не просто продаём книги. Формируем пространство для тех, кому важна история Кавказа: историков, краеведов, коллекционеров и просто любопытных.',
  },
]
