...
const STEPS = [
  {
    ...
    text: 'Больше не нужно рыскать по десяткам сайтов, аукционов и форумов. Книги по истории Кавказа — в одном каталоге, с описаниями, фотографиями и данными об издании.',
  },
  {
    number: '02',
