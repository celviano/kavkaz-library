        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              >
                История Кавказа заслуживает того, чтобы её знали
              </h2>
            </div>

            <div className="flex flex-col gap-4 text-ash text-base leading-relaxed">
              <p>
                Кавказ — один из самых сложных и богатых регионов мира. Здесь переплелись
                десятки народов, языков и религий, рождались империи и исчезали царства.
                Каждое ущелье хранит свою историю. Каждый народ — свою правду.
              </p>
              <p>
              ...
              <p>
                ...
                площадка, где всё это собрано в одном месте. Мы объединяем частных
                коллекционеров, книжные магазины, архивы и просто людей, которые хотят
                поделиться редкими изданиями со всеми, кто ищет.
              </p>
            </div>
          </div>
